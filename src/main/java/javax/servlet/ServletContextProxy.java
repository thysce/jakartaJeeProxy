...
import javax.servlet.descriptor.JspConfigDescriptorProxy;

public class ServletContextProxy  implements ServletContext {
  public final jakarta.servlet.ServletContext impl;
  public ServletContextProxy(jakarta.servlet.ServletContext impl) { this.impl = impl; }
@lombok.SneakyThrows
...
@lombok.SneakyThrows
 public ServletRegistration.Dynamic addServlet( String p0, Servlet p1) {
  return new ServletRegistration$DynamicProxy (  impl.addServlet( p0, new jakarta.servlet.ServletProxy(p1)));
 }
@lombok.SneakyThrows
...
@lombok.SneakyThrows
 public FilterRegistration.Dynamic addFilter( String p0, Filter p1) {
  return new FilterRegistration$DynamicProxy (  impl.addFilter( p0, new jakarta.servlet.FilterProxy(p1)));
 }
@lombok.SneakyThrows
