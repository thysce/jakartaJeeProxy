...
import jakarta.servlet.ReadListenerProxy;

public class ServletInputStreamProxy  extends ServletInputStream {
  public final jakarta.servlet.ServletInputStream impl;
  public ServletInputStreamProxy(jakarta.servlet.ServletInputStream impl) { this.impl = impl; }
@lombok.SneakyThrows
