...
public class ServletRequestProxy  implements ServletRequest {
  public final jakarta.servlet.ServletRequest impl;
  public ServletRequestProxy(jakarta.servlet.ServletRequest impl) { this.impl = impl; }
@lombok.SneakyThrows
...
@lombok.SneakyThrows
 public AsyncContext startAsync( ServletRequest p0, ServletResponse p1) {
  return new AsyncContextProxy (  impl.startAsync( new jakarta.servlet.ServletRequestProxy(p0), new ServletResponseProxy(p1)));
 }
@lombok.SneakyThrows
