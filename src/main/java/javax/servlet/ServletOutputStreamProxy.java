...
import jakarta.servlet.WriteListenerProxy;

public class ServletOutputStreamProxy  extends ServletOutputStream {
  public final jakarta.servlet.ServletOutputStream impl;
  public ServletOutputStreamProxy(jakarta.servlet.ServletOutputStream impl) { this.impl = impl; }
@lombok.SneakyThrows
