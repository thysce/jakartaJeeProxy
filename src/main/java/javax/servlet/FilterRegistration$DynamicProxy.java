...
public class FilterRegistration$DynamicProxy  implements FilterRegistration.Dynamic {
  public final jakarta.servlet.FilterRegistration.Dynamic impl;
  public FilterRegistration$DynamicProxy(jakarta.servlet.FilterRegistration.Dynamic impl) { this.impl = impl; }
@lombok.SneakyThrows
