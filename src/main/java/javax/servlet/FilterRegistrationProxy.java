...
public class FilterRegistrationProxy  implements FilterRegistration {
  public final jakarta.servlet.FilterRegistration impl;
  public FilterRegistrationProxy(jakarta.servlet.FilterRegistration impl) { this.impl = impl; }
@lombok.SneakyThrows
