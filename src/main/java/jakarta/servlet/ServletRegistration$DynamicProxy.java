...
import javax.servlet.MultipartConfigElementProxy;
import javax.servlet.ServletSecurityElementProxy;

public class ServletRegistration$DynamicProxy  implements ServletRegistration.Dynamic {
  public final javax.servlet.ServletRegistration.Dynamic impl;
  public ServletRegistration$DynamicProxy(javax.servlet.ServletRegistration.Dynamic impl) { this.impl = impl; }
@lombok.SneakyThrows
